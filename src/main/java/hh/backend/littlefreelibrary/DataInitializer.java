...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        // Posts
        postRepository.save(new Post("Welcome to the forum!", null, alice, null, kansalliskirjasto, 8));
        postRepository.save(new Post("Guidelines", null, bob, null, kansalliskirjasto, 7));
        postRepository.save(new Post("Best place ever!", null, charlie, null, kansalliskirjasto, 10));
        postRepository.save(new Post("Hello all!", null, david, null, kansalliskirjasto, 3));
    }
}
